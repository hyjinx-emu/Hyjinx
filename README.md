...
- **DMCA Compliance**
  ...
  The main goal of this fork was to provide a DMCA compliant emulator that allows the community to continue to tinker, while staying compliant with applicable laws. With this in mind, **this emulator is incapable of directly decrypting protected content**. If any encrypted files are used, a warning or error will be shown to the user.
