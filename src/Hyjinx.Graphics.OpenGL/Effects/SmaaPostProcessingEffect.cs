...
namespace Hyjinx.Graphics.OpenGL.Effects.Smaa
{
    internal partial class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        {
            string baseShader = EmbeddedResources.ReadAllText("Hyjinx.Graphics.OpenGL/Effects/Shaders/smaa.hlsl");
            ...
            for (int i = 0; i < +_edgeShaderPrograms.Length; i++)
            {
                ...
                var edgeShaderData = EmbeddedResources.ReadAllText("Hyjinx.Graphics.OpenGL/Effects/Shaders/smaa_edge.glsl");
                var blendShaderData = EmbeddedResources.ReadAllText("Hyjinx.Graphics.OpenGL/Effects/Shaders/smaa_blend.glsl");
                var neighbourShaderData = EmbeddedResources.ReadAllText("Hyjinx.Graphics.OpenGL/Effects/Shaders/smaa_neighbour.glsl");
        ...
        private void Initialize()
        {
            ...
            var areaTexture = EmbeddedResources.ReadFileToRentedMemory("Hyjinx.Graphics.OpenGL/Effects/Textures/SmaaAreaTexture.bin");
            var searchTexture = EmbeddedResources.ReadFileToRentedMemory("Hyjinx.Graphics.OpenGL/Effects/Textures/SmaaSearchTexture.bin");
