...
namespace Hyjinx.HLE.HOS.Services.Ssl
{
    partial class BuiltInCertificateManager
    {
        ...
        private const string CertStoreTitleMissingErrorMessage = "CertStore system title not found! SSL CA retrieving will not work, provide the system archive to fix this error. (See https://github.com/ryujinx-mirror/Hyjinx/wiki/Hyjinx-Setup-&-Configuration-Guide#initial-setup-continued---installation-of-firmware for more information)";
