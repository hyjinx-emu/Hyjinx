...
namespace Hyjinx.Graphics.Vulkan.Effects
{
    internal class FsrScalingFilter : IScalingFilter
    {
        ...
        public void Initialize()
        {
            ...
            var scalingShader = EmbeddedResources.Read("Hyjinx.Graphics.Vulkan/Effects/Shaders/FsrScaling.spv");
            var sharpeningShader = EmbeddedResources.Read("Hyjinx.Graphics.Vulkan/Effects/Shaders/FsrSharpening.spv");
