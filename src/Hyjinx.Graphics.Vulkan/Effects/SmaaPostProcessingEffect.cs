...
namespace Hyjinx.Graphics.Vulkan.Effects
{
    internal class SmaaPostProcessingEffect : IPostProcessingEffect
    {
        ...
        private void RecreateShaders(int width, int height)
        {
            ...
            var edgeShader = EmbeddedResources.Read("Hyjinx.Graphics.Vulkan/Effects/Shaders/SmaaEdge.spv");
            var blendShader = EmbeddedResources.Read("Hyjinx.Graphics.Vulkan/Effects/Shaders/SmaaBlend.spv");
            var neighbourShader = EmbeddedResources.Read("Hyjinx.Graphics.Vulkan/Effects/Shaders/SmaaNeighbour.spv");
        ...
        private void Initialize()
        {
            ...
            var areaTexture = EmbeddedResources.ReadFileToRentedMemory("Hyjinx.Graphics.Vulkan/Effects/Textures/SmaaAreaTexture.bin");
            var searchTexture = EmbeddedResources.ReadFileToRentedMemory("Hyjinx.Graphics.Vulkan/Effects/Textures/SmaaSearchTexture.bin");
