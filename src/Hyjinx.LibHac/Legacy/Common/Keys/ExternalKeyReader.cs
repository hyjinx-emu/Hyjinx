...
public static partial class ExternalKeyReader
{
    ...
    public static void ReadKeyFile(KeySet keySet, string? filename = null, string? titleKeysFilename = null, string? consoleKeysFilename = null, IProgressReport? logger = null)
    {
    ...
    /// <param name="logger">An optional logger that key-parsing errors will be written to.</param>
    private static void ReadMainKeys(KeySet keySet, Stream reader, List<KeyInfo> keyList, IProgressReport? logger = null)
    {
    ...
    /// <param name="reader">A <see cref="Stream"/> containing the keys to load.</param>
    /// <param name="logger">An optional logger that key-parsing errors will be written to.</param>
    private static void ReadTitleKeys(KeySet keySet, Stream reader, IProgressReport? logger = null)
    {
        using var streamReader = new StreamReader(reader);
        Span<char> buffer = stackalloc char[ReadBufferSize];
        var ctx = new KvPairReaderContext(streamReader, buffer);
