...
Most content is imported and exported using a standard IStorage interface. This means that reading nested content bodies can easily be done by chaijing different storage implementations together.
