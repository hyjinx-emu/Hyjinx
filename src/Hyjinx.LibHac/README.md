...
Most content is imported and exported using a standard [IStorage](Fs/IStorage.cs) interface. This means that reading content bodies can easily be done by chaining different storage implementations together.
