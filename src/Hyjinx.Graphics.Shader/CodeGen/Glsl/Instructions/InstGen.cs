...
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenBallot;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenCall;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenFSI;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenHelper;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenMemory;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenPacking;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenShuffle;
using static Hyjinx.Graphics.Shader.CodeGen.Glsl.Instructions.InstGenVector;
