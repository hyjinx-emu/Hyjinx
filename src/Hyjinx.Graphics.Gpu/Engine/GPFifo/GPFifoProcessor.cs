...
using Hyjinx.Graphics.Gpu.Engine.Compute;
using Hyjinx.Graphics.Gpu.Engine.Dma;
using Hyjinx.Graphics.Gpu.Engine.InlineToMemory;
using Hyjinx.Graphics.Gpu.Engine.Threed;
using Hyjinx.Graphics.Gpu.Engine.Twod;
using Hyjinx.Graphics.Gpu.Image;
using Hyjinx.Graphics.Gpu.Memory;
using System;
using System.Runtime.CompilerServices;

namespace Hyjinx.Graphics.Gpu.Engine.GPFifo
{
    /// <summary>
